...
{  
    ...
    public static void DrawGameState(GameState state, Main main, Player player,GameTime gameTime)
    {
        DrawCollisionMap(state, main);
        DrawDataTable(state, main, player);
    }

    public static void DrawMainMenuState(GameTime gameTime)
    {
        DrawComponentBoundHighlights(gameTime);
    }
    ...
    public static void DrawComponentBoundHighlights(GameTime gameTime)
    {
        Globals.MenuHandler.DebugDraw(gameTime);
    }
